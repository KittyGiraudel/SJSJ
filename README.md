...
* [Closure](/glossary/CLOSURE.md): a closure is the local variables for a function.
...
* [Meteor](/glossary/METEOR.md): it is a js web framework that allows rapid prototypic web developement

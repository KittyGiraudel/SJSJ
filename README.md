...
* [V8](/glossary/V8.md): V8 is Google's open source javaScript engine. It's what Chrome is running, but it's also used for other projects like Node.js and MongoDB.

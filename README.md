...
[Ionic](http://ionicframework.com/) is a hybrid mobile application building framework, using HTML, CSS and Javascript, mainly used together with [AngularJS](#angularjs). It contains a bunch of CLI tools to create, test and publish applications for iOS and Android devices, which can be still viewed as a mobile web app.

...
This process is done by calling the function with one parameter, and return a new function with the parameter already bound inside a [closure](/glossary/CLOSURE.md).
...
[Lodash](/glossary/LODASH.md), [Wu](https://fitzgen.github.io/wu.js/#curryable) and [Ramda](/glossary/RAMDA.md) are 3 of the many libraries that provide currying.
